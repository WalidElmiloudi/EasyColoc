                                    ...
                                    <li
                                        ...
                                        <div class="flex gap-1">
                                            @if (auth()->user()->colocation_role === 'owner')
                                                <div class="flex gap-2">
                                                    <form method="POST"
                                                        action="{{ route('colocation.members.transfer', $member) }}"
                                                        onsubmit="return confirm('Are you sure you want to make {{ $member->name }} the owner?');">
                                                        @csrf
                                                        <button type="submit"
                                                            class="p-1.5 text-slate-400 hover:text-blue-600 transition cursor-pointer"
                                                            title="Passer propriétaire">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                viewBox="0 0 24 24" stroke-width="2"
                                                                stroke="currentColor" class="pointer-events-none w-4 h-4">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="p-1.5 text-slate-400 hover:text-red-500 transition cursor-pointer"
