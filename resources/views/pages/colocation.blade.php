        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="mt-4 sm:mt-0 flex items-center gap-2 bg-indigo-50 p-2 rounded-xl border border-indigo-200">
                    <span
                        class="text-xs font-mono bg-white px-3 py-2 rounded-lg border border-indigo-100 text-indigo-800">COLOC-MTR-2025</span>
                    <button class="bg-indigo-600 hover:bg-indigo-700 text-white p-2 rounded-lg transition"
                        title="Copier le token">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor" class="w-4 h-4">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H3.375c-.621 0-1.125.504-1.125 1.125v9.75c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9.75c0-.621-.504-1.125-1.125-1.125h-2.25" />
                        </svg>
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        ...
                        <p class="text-sm text-slate-500 mb-4">Définis les catégories qui seront utilisées pour les dépenses
                        ...
                        <div class="flex gap-2">
                            <input type="text" placeholder="Nouvelle catégorie (ex: Internet)"
                        ...
                        <p class="text-xs text-slate-400 mt-2">Les membres pourront utiliser ces catégories lors de l'ajout
                            d'une dépense.</p>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        ...
                        <p class="text-sm text-slate-500 mb-4">Envoie le token ou copie-le pour inviter d'autres personnes.
                        </p>
                        ...
                        <div class="border-t border-slate-200 pt-4">
                            <label class="block text-sm font-medium text-slate-700 mb-2">Ou envoie une invitation par
                                e-mail</label>
                            <div class="flex gap-2">
                                <input type="email" placeholder="coloc@exemple.fr"
                                    class="flex-1 px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-indigo-300 outline-none transition text-sm">
                                <button
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        ...
                        <ul class="space-y-3">
                            ...
                            <li
                                ...
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-8 h-8 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center font-semibold text-xs">
                                        J</div>
                                    <div>
            ...
            <div
                ...
                <span>Les dépenses seront ajoutées et gérées par les membres dans la « colocation room ». Ici tu configures
                    la coloc.</span>
            </div>
        </main>
    </div>
